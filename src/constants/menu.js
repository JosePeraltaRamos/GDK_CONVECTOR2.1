...
const data = [
    {
     ...
     } ,
     {
        ...
        label:"Gestor Documentario",
        to:"/app/Documentario"
     },
     {
        id:"mantenimiento",
        icon:"simple-icon-lock",
        label:"menu.mantenimiento",
        to:"/app/mantenimiento",
        subs:[
          {
           icon:"iconsminds-ship",
           label:"menu.Linea",
           to:"/app/mantenimiento/Linea"
          },
          {
            icon:"iconsminds-sailing-ship",
            label:"menu.Nave",
            to:"/app/mantenimiento/Nave"
           },
           {
            icon:"iconsminds-sailing-ship",
            label:"POL",
            to:"/app/mantenimiento/Pol"
           },
           {
            icon:"iconsminds-sailing-ship",
            label:"POD",
            to:"/app/mantenimiento/Pod"
           },
           {
            icon:"iconsminds-sailing-ship",
            label:"Tipo Contenedor",
            to:"/app/mantenimiento/TContenedor"
           },
           {
            icon:"iconsminds-sailing-ship",
            label:"Material",
            to:"/app/mantenimiento/Material"
           },
           {
            icon:"iconsminds-sailing-ship",
            label:"Tipo Embalaje",
            to:"/app/mantenimiento/TEmbalaje"
           },
           {
            icon:"iconsminds-sailing-ship",
            label:"Operador Logístico",
            to:"/app/mantenimiento/OLogistico"
           },
           {
            icon:"iconsminds-sailing-ship",
            label:"Déposito retiros vacíos",
            to:"/app/mantenimiento/DRetiro"
           }
        ]
     },
    {
