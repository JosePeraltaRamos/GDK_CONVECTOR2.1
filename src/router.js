...
const routes = [
  {
    ...
    children: [
      {
         path:'app/booking',
         component: ()=>import(/* webpackChunkName: "Bookings" */'./views/app/booking'),
         redirect: '/app/booking/Bookings',
         children: [
          { path: 'Bookings', component: () => import(/* webpackChunkName: "Bookings" */ './views/app/booking/Bookings') }
         ]
      },
      {
        path:'app/mantenimiento',
        component:()=>import(/* webpackChunkName: "mantenimiento" */'./views/app/mantenimiento'),
        redirect:'/app/mantenimiento/Linea',
        children:[
          {path:'Linea' ,component:()=>import(/* webpackChunkName: "Linea" */'./views/app/mantenimiento/Linea')},
          { path:'Nave' , component:()=>import(/* webpackChunkName: "Nave" */'./views/app/mantenimiento/Nave')}
        ]
      },
      {
        path: 'app/dashboards',
